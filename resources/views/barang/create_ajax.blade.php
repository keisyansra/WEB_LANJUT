            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <select name="kategori_id" id="kategori_id" class="form-control" required>
                        ...
                        <option value="{{ $k->kategori_id }}">{{ $k->kategori_kode }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input value="" type="number" name="harga_beli" id="password" class="form-control" required>
                    <small id="error-harga_beli" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Harga Jual</label>
                    <input value="" type="number" name="harga_jual" id="password" class="form-control" required>
